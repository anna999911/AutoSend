...
# fifth_pic="https://i.ibb.co/9V2ygv3/5.jpg"
# 計算正在轉第幾個檔案
count=0
...
for z in name_list:
    ...
    #     recipients = ['ryanbo1982@gmail.com','ryan.hsu@shubaoex.com']
        ...
        # 建立郵件主題
        outer = MIMEMultipart()
        subject='【數寶數位資產管理_以太幣定投服務】每月對帳單_'+name1+'_第'+str(count_whichmonth-1)+'期'
        ...
        attachments = [r'C:/Users/數寶數位資產管理/Documents/'+'數寶數位資產對帳單_'+z+'.pdf','數寶數位資產管理_產品單張DM.pdf','以太幣每月定期定額投資 2018年 _ 2021年以來每年的定投報酬率.pdf']
        # HTML檔案位置
        path = 'C:/Users/數寶數位資產管理/desktop/202110/letter_html_ETH.html'
